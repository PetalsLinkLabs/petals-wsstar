...
public class WsnbJaxbModelFaultsUnitTest extends AbsWsnbFaultsUnitTests {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ebmwebsourcing.notification.api.basenotification.test.AbsWsnbFaultsUnitTests#setWsnbModelFactory()
	 */
	@Override
...
//		this.isDebug = true;
	...
	/*
	 * (non-Javadoc)
	 * @see com.ebmwebsourcing.notification.api.basenotification.test.AbsWsnbFaultsUnitTests#initRequiredDependencyModelFactories()
	 */
	@Override
