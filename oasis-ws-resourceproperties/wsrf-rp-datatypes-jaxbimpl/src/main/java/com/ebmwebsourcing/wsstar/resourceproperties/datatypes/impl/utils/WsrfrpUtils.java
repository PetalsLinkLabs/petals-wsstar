...
package com.ebmwebsourcing.wsstar.resourceproperties.datatypes.impl.utils;
...
public final class WsrfrpUtils {
	...
	public static XMLGregorianCalendar toXMLGregorianCalendar(Date time, Logger logger) {		
		...
		return WsrfrpUtils.toXMLGregorianCalendar(timeAsCalendar, logger);
	}
