 ...
 * -------------------------------------------------------------------------
 */
package com.ebmwebsourcing.wsstar.resourcelifetime.datatypes.impl.utils;
 ...
 */
public class WsrfrlJAXBPrefixMapper extends NamespacePrefixMapper {
	...
	public WsrfrlJAXBPrefixMapper() {	
		this.initKnownNsMapping();	
	}
	
	public WsrfrlJAXBPrefixMapper(String[] customNamespaces) {	
		this.initKnownNsMapping();			
