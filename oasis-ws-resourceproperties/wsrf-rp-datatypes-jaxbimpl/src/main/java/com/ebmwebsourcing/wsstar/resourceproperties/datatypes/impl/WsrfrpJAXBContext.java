 ...
 * -------------------------------------------------------------------------
 */
package com.ebmwebsourcing.wsstar.resourceproperties.datatypes.impl;
 ...
 */
public final class WsrfrpJAXBContext {
	
	private static Logger log = Logger.getLogger(WsrfrpJAXBContext.class.getName());
     ...
     */    
    public static final com.ebmwebsourcing.wsstar.jaxb.resource.resourceproperties.ObjectFactory WSRFRP_JAXB_FACTORY = 
	 ...
	 */
    private static final class WsrfrpJAXBContextHolder {     	
		private static final WsrfrpJAXBContext INSTANCE = new WsrfrpJAXBContext();
		
		private WsrfrpJAXBContextHolder(){}
	}
    
    /**
	 * Return an unique - respect to the Singleton design pattern - instance  
	 * of the {@link WsrfrpJAXBContext} class.  
	 * 
	 * @return a unique {@link WsrfrpJAXBContext} instance. 
	 */
	public static WsrfrpJAXBContext getInstance() {
		return WsrfrpJAXBContextHolder.INSTANCE;
	}
	 ...
	 * @return a unique {@link WsrfrpJAXBContext} instance. 
	 */
	public static WsrfrpJAXBContext getInstance(String[] nsAndPrefixForMarshalling) {
		WsrfrpJAXBContext context = WsrfrpJAXBContextHolder.INSTANCE;
     ...
     */
    public Marshaller createWSResourcePropertiesMarshaller() throws JAXBException{
     ...
     * @throws JAXBException
     */
    public Unmarshaller createWSResourcePropertiesUnmarshaller() throws JAXBException{
